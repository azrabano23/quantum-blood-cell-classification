...
Seed: 42
Prints intermediary values to terminal AND saves to vqc_output_seed42.txt
"""
...
def train_vqc(X_train, y_train, n_qubits=4, max_iter=200):
    n_params = n_qubits * 3  # RealAmplitudes 2 reps → 4*(2+1)=12
...
if __name__ == "__main__":
    ...
    if not os.path.exists(dataset_path):
        ...
        print("Usage: python vqc_sabia_seed42.py <dataset_path>")
        sys.exit(1)

    N_SAMPLES = 250  # samples per class
    N_QUBITS  = 4
